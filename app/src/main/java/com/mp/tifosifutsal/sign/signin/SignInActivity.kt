package com.mp.tifosifutsal.sign.signin
...
import com.mp.tifosifutsal.sign.signup.SignUpActivity
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (user == null) {
                    ...
                    if (user.password.equals(iPassword)){
                        ...
                        preferences.setValues("no_hp", user.no_hp.toString())
                        preferences.setValues("username", user.username.toString())
                        preferences.setValues("foto", user.foto.toString())
